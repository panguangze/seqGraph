...
typedef std::unordered_map<std::string, std::unordered_map<std::string, std::vector<bam1_t *>>> Interactions;

void readBAM(htsFile *in, std::string &out_file, int readLen, std::unordered_map<std::string, int>& fais);
#endif //E_RESULT_H